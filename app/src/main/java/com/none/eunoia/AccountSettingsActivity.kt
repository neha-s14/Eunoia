        ...
        when {
            ...
            bio_profile_frag.text.toString()=="" -> {
                ...
                val userMap = HashMap<String, Any>()
                    userMap.put("fullname", full_name_profile_frag.text.toString())
                    userMap.put("username", username_profile_frag.text.toString())
                    userMap.put("bio", bio_profile_frag.text.toString())
